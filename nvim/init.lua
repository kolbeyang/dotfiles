...
-- Disable newline comment behavior
vim.api.nvim_create_autocmd('BufWinEnter', {
  command = 'set formatoptions-=cro',
})

-- Treat mdx files like md files
vim.filetype.add {
  extension = {
    mdx = 'markdown', -- treat mdx like markdown
  },
}
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sD', builtin.diagnostics, { desc = '[S]earch [D]iagnostics in file' })
      ...
      end, { desc = '[S]earch [D]iagnostics in open buffers' })
      ...
      -- Snippet Engine & its associated nvim-cmp source
      {
        ...
        config = function()
          require('luasnip.loaders.from_vscode').lazy_load {
            paths = { '~/.config/nvim/snippets' }, -- Custom path for your snippets
          }
        end,
        dependencies = {
